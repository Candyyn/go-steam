...
func (g *GameCoordinator) SendClientHello() {
	...
	//hello := gamecoordinator.NewGCMsgProtobuf(uint32(730), uint32(protobuf.EGCBaseClientMsg_k_EMsgGCClientHello), &protobuf.CMsgClientHello{ProtocolVersion: proto.Uint32(2000202)})
	//g.Write(hello)
}

func (g *GameCoordinator) InspectUrl() {
