...
const file_cstrike15_gcmessages_proto_rawDesc = "" +
	...
	"serverinfo\x12N\n" +
	"\x14match_end_quest_data\x18\x04 \x01(\v2\x1d.CMsgGC_ServerQuestUpdateDataR\x11matchEndQuestData\"\xec\b\n" +
	...
	"variations\x12#\n" +
	"\rupgrade_level\x18\x17 \x01(\rR\fupgradeLevel\x1a\xad\x02\n" +
	"\aSticker\x12\x12\n" +
	...
	"\apattern\x18\n" +
	" \x01(\rR\apattern\x12%\n" +
	"\x0ehighlight_reel\x18\v \x01(\rR\rhighlightReel\"l\n" +
	...
	"\x11mission_templates\x18\x02 \x03(\fR\x10missionTemplates*\x96*\n" +
	"\n" +
	"ECsgoGCMsg\x12\x1e\n" +
	...
	"+k_EMsgGCCStrike15_v2_RecurringMissionSchema\x10\x8aH*\x98\x01\n" +
